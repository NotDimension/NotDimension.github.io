  ...
  return (
    <section className="py-24 px-4">
      <div className="container max-w-3xl mx-auto">
        ...
        >
          <h2 className="section-heading text-sm font-mono mb-10 tracking-widest uppercase">
            // Connect With Me
          </h2>
          <div className="flex flex-wrap justify-center gap-4">
            {socials.map((social, i) => (
              ...
              >
                <img src={social.icon} alt={social.name} width="16" height="16" loading="lazy" decoding="async" className="w-4 h-4 opacity-70 group-hover:opacity-100 transition-opacity social-icon" />
