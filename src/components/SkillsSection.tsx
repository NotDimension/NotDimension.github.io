  ...
  return (
    <section className="py-24 px-4">
      <div className="container max-w-3xl mx-auto">
        ...
        >
          <h2 className="section-heading text-sm font-mono mb-8 tracking-widest uppercase">// Skills & Expertise</h2>
          ...
          <h2 className="section-heading text-sm font-mono mb-8 tracking-widest uppercase">// Daily Responsibilities</h2>
