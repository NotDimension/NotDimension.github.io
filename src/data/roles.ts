...
export interface RoleEntry {
  ...
  archived?: boolean;
  /** If true, never show the Discord banner — use a plain gradient instead. */
  noBanner?: boolean;
}
...
export const currentRoles: RoleEntry[] = [
  ...
  { name: "smpfinder.com", role: "Moderator", members: "1.3k", staticMembers: 1300, icon: "/placeholder.svg", discord: "https://discord.gg/XvKk2W6KXx", description: "Community hub for the smpfinder.com server list — moderating chat and helping members." },
  ...
  { name: "New Server", role: "Moderator", members: "100", staticMembers: 100, icon: "/placeholder.svg", discord: "https://discord.gg/a4QhuPD797", description: "Moderating chat and helping members." },
  { name: "MC SALES", role: "General Manager", members: "779", staticMembers: 779, icon: "/placeholder.svg", discord: "https://discord.gg/wejeWWryjs", description: "Welcome to MC SALES, we are a team of service providers bringing more to you! Come join the server for more information!", noBanner: true },
];
