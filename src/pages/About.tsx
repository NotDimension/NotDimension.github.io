...
const timeline = [
  ...
  { month: "May 2026", events: ["Hired at smpfinder.com as a Moderator."] },
  { month: "June 2026", events: ["Hired as a Moderator @ Sparkle SMP. In which I made their logo aswell. Hired as General Manager @ MC SALES." ] },
  { month: "Ongoing", events: ["Currently Co-Owner at ShadySMP, General Manager at MC SALES, Mod at smpfinder.com, Mod at Sparkle SMP and Admin at SMPFinder."] },
];

const interests = [
  { icon: Music, title: "Music", items: ["Favourite artist: Brent Faiyaz", "Genres: RNB, Lo-fi & Alternative"] },
  ...
  <div className="page-container noise-overlay relative z-10 min-h-screen">
    ...
    <div className="px-4 pb-24">
      <div className="container max-w-3xl mx-auto space-y-20">
        {/* Background */}
        <section>
          <h2 className="section-heading text-sm font-mono mb-6 tracking-widest uppercase">// Background</h2>
          <m.p
        ...
        {/* Timeline */}
        <section>
          <h2 className="section-heading text-sm font-mono mb-8 tracking-widest uppercase">// Journey</h2>
        ...
        {/* Interests */}
        <section>
          <h2 className="section-heading text-sm font-mono mb-6 tracking-widest uppercase">// Beyond Servers</h2>
