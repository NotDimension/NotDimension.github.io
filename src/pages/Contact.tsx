...
const CommunityCard = ({ c, i }: { c: (typeof communities)[number]; i: number }) => {
  ...
  return (
    ...
    >
      <div className="w-12 h-12 rounded-lg overflow-hidden bg-secondary flex-shrink-0 transition-all duration-300 hover:scale-[1.06] hover:shadow-[0_0_20px_hsl(var(--accent)/0.3)]">
        <img
          src={iconSrc}
          alt={displayName}
  ...
  <div className="page-container noise-overlay relative z-10 min-h-screen">
    ...
    <div className="px-4 pb-24">
      <div className="container max-w-3xl mx-auto space-y-20">
        {/* Contact methods */}
        <section>
          <h2 className="section-heading text-sm font-mono mb-6 tracking-widest uppercase">// Ways to Reach Me</h2>
          <div className="grid gap-4">
            ...
            <m.a href="mailto:notdimension1@gmail.com"
            ...
            >
              <div className="flex items-start gap-5">
                ...
                <div className="flex-1">
                  ...
                  <code className="text-sm font-mono text-foreground">notdimension1@gmail.com</code>
                </div>
                <ExternalLink className="w-4 h-4 text-muted-foreground group-hover:text-primary transition-colors flex-shrink-0" />
              </div>
            </m.a>
        ...
        {/* Response times */}
        <section>
          <h2 className="section-heading text-sm font-mono mb-6 tracking-widest uppercase">// Response Times</h2>
        ...
        {/* Communities */}
        <section>
          <h2 className="section-heading text-sm font-mono mb-6 tracking-widest uppercase">// Find Me In These Communities</h2>
