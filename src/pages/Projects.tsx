  ...
  <div className="page-container noise-overlay relative z-10 min-h-screen">
    ...
    <div className="px-4 pb-24">
      <div className="container max-w-3xl mx-auto space-y-20">
        {/* Live */}
        <section>
          <h2 className="section-heading text-sm font-mono mb-6 tracking-widest uppercase">// Live Projects</h2>
        ...
        {/* Technical */}
        <section>
          <h2 className="section-heading text-sm font-mono mb-6 tracking-widest uppercase">// Technical Creations</h2>
          <div className="grid gap-4">
        ...
        {/* Archived */}
        <section>
          <h2 className="section-heading text-sm font-mono mb-6 tracking-widest uppercase flex items-center gap-2">
